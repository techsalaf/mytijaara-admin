            ...
            <div class="row pt-2">
                <div class="col-md-12">
                    <div class="resturant-card-navbar">
                        ...
                        <div class="order-info-item filter-on-click {{ (request()->input('filter') == 'all_orders' || !request()->input('filter')) ? 'bg-soft-success' : '' }}" data-type='all_orders' data-filter="filter" data-url="{{route('admin.store.view', ['store'=>$store->id, 'tab'=> 'order'])}}">
                        ...
                        <div class="order-info-item filter-on-click {{ request()->input('filter') == 'scheduled_orders' ? 'bg-soft-success' : '' }}"  data-filter="filter"  data-type="scheduled_orders" data-url="{{route('admin.store.view', ['store'=>$store->id, 'tab'=> 'order'])}}"  >
                            <div class="order-info-icon">
                        ...
                        <span class="order-info-seperator"></span>
                        <div class="order-info-item filter-on-click {{ request()->input('filter') == 'pending_orders' ? 'bg-soft-success' : '' }}"   data-filter="filter"  data-type="pending_orders" data-url="{{route('admin.store.view', ['store'=>$store->id, 'tab'=> 'order'])}}" >
                            <div class="order-info-icon">
                        ...
                        <span class="order-info-seperator"></span>
                        <div class="order-info-item filter-on-click {{ request()->input('filter') == 'delivered_orders' ? 'bg-soft-success' : '' }}"  data-filter="filter"  data-type="delivered_orders" data-url="{{route('admin.store.view', ['store'=>$store->id, 'tab'=> 'order'])}}" >
                            <div class="order-info-icon">
                        ...
                        <span class="order-info-seperator"></span>
                        <div class="order-info-item filter-on-click {{ request()->input('filter') == 'canceled_orders' ? 'bg-soft-success' : '' }}"  data-filter="filter"  data-type="canceled_orders" data-url="{{route('admin.store.view', ['store'=>$store->id, 'tab'=> 'order'])}}" >
                            <div class="order-info-icon">
