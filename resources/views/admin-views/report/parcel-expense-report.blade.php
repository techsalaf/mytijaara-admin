...
@section('title', translate('Parcel Expense Report'))
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ translate('Parcel Expense Report') }}
                </span>
            </h1>
        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <select class="form-control js-select2-custom set-filter" data-url="{{ url()->full() }}" data-filter="type" name="type">
                                ...
                                @php
                                    // Parcel orders skip the item-discount branches at OrderLogic
                                    // L207-235 (gated by `if $type != 'parcel'`), so item-level
                                    // types (discount_on_product, flash_sale_discount,
                                    // extra_discount, pro_discount_on_product) never appear here.
                                    $parcelTypes = [
                ...
                <div class="search--button-wrapper">
                    ...
                    <div class="hs-unfold ml-3">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="{{route('admin.transactions.report.parcel-expense-export', ['export_type'=>'excel',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2" src="{{ asset('public/assets/admin') }}/svg/components/excel.svg" alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item" href="{{route('admin.transactions.report.parcel-expense-export', ['export_type'=>'csv',request()->getQueryString()])}}">
                        ...
                        <tbody id="set-rows">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($exp->order)
                                        <div>
                                            <a class="text-dark" href="{{ route('admin.transactions.parcel.order.details', $exp->order->id) }}">{{ $exp['order_id'] }}</a>
                                        </div>
                                    @else
