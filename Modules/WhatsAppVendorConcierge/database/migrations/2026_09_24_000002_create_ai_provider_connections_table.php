    ...
    public function up(): void
    {
        if (!Schema::hasTable('ai_provider_connections')) {
            Schema::create('ai_provider_connections', function (Blueprint $table) {
                ...
                $table->string('status')->default('healthy'); // healthy, degraded, rate_limited, cooldown, auth_failed, budget_exhausted, disabled
                ...
                $table->string('selection_mode')->default('all_compatible'); // all_compatible, manual, auto_include_free
