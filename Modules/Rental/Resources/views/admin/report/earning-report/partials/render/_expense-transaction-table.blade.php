                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if(isset($t['source_type']))
                            @php
                                $sourceBadgeClass = $t['source_type'] == 'Provider'
                                    ? 'text-warning bg-warning'
                                    : ($t['source_type'] == 'Tax Office' ? 'text-success bg-success' : 'text-info bg-info');
                            @endphp
                            <div class="badge {{ $sourceBadgeClass }} bg-opacity-10 rounded-lg font-medium px-2">
