                ...
                <div>
                    ...
                    @if ($show_comparison)
                        <div class="opacity-lg fs-14 mb-2">
                            {{ $summary['admin_earning_percentage'] == 0 ? '' : ($summary['admin_earning_positive'] ? '↑' : '↓') }}
        ...
        <div class="card-shape-in position-relative bg-warning-gradient text-white rounded-10 p-3 p-xxl-20 d-flex gap-2 justify-content-between align-items-start overflow-hidden z-2 cursor-pointer">
            <div class="flex-grow-1 d-flex flex-column h-100">
                <div>
                    ...
                    @if ($show_comparison)
                        <div class="opacity-lg fs-14 mb-2">
                            {{ $summary['admin_expense_percentage'] == 0 ? '' : ($summary['admin_expense_positive'] ? '↑' : '↓') }}
            ...
            <div class="flex-grow-1 d-flex flex-column h-100">
                <div>
                    <div class="fs-14 mb-2">
                        <span class="opacity-lg">{{ translate('messages.Net_Profit') }}</span>
                    ...
                    @if ($show_comparison)
                        <div class="opacity-lg fs-14 mb-2">
                            {{ $summary['net_profit_percentage'] == 0 ? '' : ($summary['net_profit_positive'] ? '↑' : '↓') }}
