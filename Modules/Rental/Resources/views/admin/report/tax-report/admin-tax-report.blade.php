        ...
        <h2 class="mb-20">{{ translate('messages.Admin Trip Tax Report') }}</h3>
            <div class="card p-20 mb-20">
                ...
                <span id="info_for_item">
                    {{ translate('Here you can see admin tax report only for Rental Module. You can view') }}
                    <a href="{{  route('admin.transactions.report.getTaxReport') }}"
                        class="font-semibold theme-clr text-decoration-underline">{{ translate('All Module Combine Tax Report') }}.</a>
