                            ...
                            <div class="order-invoice-left d-flex d-sm-block justify-content-between">
                                <div>
                                    ...
                                    <div class="fs-14 text-title mt-2 pt-1 mb-2 d-flex align-items-center __gap-5px">
                                        ...
                                        <span class="font-bold d-inline-flex align-items-center __gap-5px">{{ $trip?->provider?->name }}
                                            @if ($verified_seller_badge == 1 && $trip?->provider?->storeConfig?->verified_seller)
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        ...
                        <a class="media align-items-center deco-none resturant--information-single" href="{{ route('admin.rental.provider.details', $trip->provider_id) }}">
                            ...
                            <div class="media-body">
                                <div class="text--title fs-14 font-semibold d-flex align-items-center __gap-5px text-hover-primary mb-1">
                                    {{ $trip?->provider?->name }}
                                    @if ($verified_seller_badge == 1 && $trip?->provider?->storeConfig?->verified_seller)
                                        <img src="{{ asset('public/assets/admin/img/checked-badge.svg') }}" alt="" class="rounded-0 w-auto h-auto object-contain">
                                    @endif
