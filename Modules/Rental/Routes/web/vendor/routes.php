...
use Modules\Rental\Http\Controllers\Web\Provider\ProviderEarningReportController;
...
Route::group([ 'middleware' => ['vendor', 'provider-rental-module']], function () {
    ...
    Route::group(['prefix' => 'report', 'as' => 'report.', 'middleware' => ['module:report']], function () {
        Route::get('earning-report', [ProviderEarningReportController::class, 'index'])->name('earning-report');
        Route::get('earning-summary', [ProviderEarningReportController::class, 'getEarningSummary'])->name('earning-summary');
        Route::get('earning-breakdown', [ProviderEarningReportController::class, 'getEarningBreakdown'])->name('earning-breakdown');
        Route::get('expense-breakdown', [ProviderEarningReportController::class, 'getExpenseBreakdown'])->name('expense-breakdown');
        Route::get('earning-trend', [ProviderEarningReportController::class, 'getEarningTrend'])->name('earning-trend');
        Route::get('earning-transactions', [ProviderEarningReportController::class, 'getEarningTransactions'])->name('earning-transactions');
        Route::get('earning-export', [ProviderEarningReportController::class, 'exportEarningTransactions'])->name('earning-export');
    ...
    Route::group(['prefix' => 'custom-role', 'as' => 'custom-role.', 'middleware' => ['module:employee']], function () {
        ...
        Route::get('update/{id}', [ProviderController::class, 'update'])->name('update-employee');
    });
