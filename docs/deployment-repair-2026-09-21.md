...
- The module status file dropped `WhatsAppVendorConcierge`, disabling its routes, commands and listeners. Its enabled entry is restored alongside the imported Service entry.
